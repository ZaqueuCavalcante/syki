...
public class CreateCourseOfferingService(EstudDbContext ctx) : IEstudService
{
    ...
    public async Task<OneOf<CreateCourseOfferingOut, EstudError>> Create(CreateCourseOfferingIn data)
    {
