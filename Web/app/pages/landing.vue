...
useSeoMeta({
  title: 'Estud — Gestão acadêmica simplificada',
  description: 'Plataforma completa para instituições de ensino. Gerencie alunos, professores, turmas e muito mais em um só lugar.',
})
