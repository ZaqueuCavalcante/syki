...
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new SykiError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6() }.Select(e => e.ToSwaggerExampleErrorOut());
}
...
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new SykiError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7() }.Select(e => e.ToSwaggerExampleErrorOut());
}
...
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new SykiError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7(), new T8() }.Select(e => e.ToSwaggerExampleErrorOut());
}
...
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new SykiError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7(), new T8(), new T9() }.Select(e => e.ToSwaggerExampleErrorOut());
}
...
public abstract class ErrorExamplesProvider<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IMultipleExamplesProvider<ErrorOut>
    ...
    where T8 : SykiError, new()
    where T9 : SykiError, new()
    where T10 : SykiError, new()
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new SykiError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7(), new T8(), new T9(), new T10() }.Select(e => e.ToSwaggerExampleErrorOut());
}
...
public abstract class ErrorExamplesProvider<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IMultipleExamplesProvider<ErrorOut>
    ...
    where T9 : SykiError, new()
    where T10 : SykiError, new()
    where T11 : SykiError, new()
{
    public IEnumerable<SwaggerExample<ErrorOut>> GetExamples() =>
        new SykiError[] { new T1(), new T2(), new T3(), new T4(), new T5(), new T6(), new T7(), new T8(), new T9(), new T10(), new T11() }.Select(e => e.ToSwaggerExampleErrorOut());
}
