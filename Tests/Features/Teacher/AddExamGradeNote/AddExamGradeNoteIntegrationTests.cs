...
public partial class IntegrationTests
{
    ...
    public async Task Should_add_exam_grade_note()
    {
        ...
        ClassOut mathClass = await academicClient.CreateClass(data.Disciplines.DiscreteMath.Id, chico.Id, data.AcademicPeriod.Id, 40, [ new(Day.Monday, Hour.H07_00, Hour.H10_00) ]);
