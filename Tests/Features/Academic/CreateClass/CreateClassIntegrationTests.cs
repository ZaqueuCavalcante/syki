...
public partial class IntegrationTests : IntegrationTestBase
{
    ...
    public async Task Should_not_create_class_without_period()
    {
        ...
        // Act
        var response = await client.CreateClassHttp(discipline.Id, teacher.Id, "2024.1", []);
    ...
    public async Task Should_not_create_class_with_invalid_schedule()
    {
        ...
        // Act
        var response = await client.CreateClassHttp(discipline.Id, teacher.Id, period.Id, schedules);
