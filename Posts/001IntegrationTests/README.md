...
- O sistema realizou o processamento de 1.055 eventos de domínio e de 1.055 tarefas em background
...
- Aguardo o sistema processar o evento de domínio gerado (que enfilera a tarefa SendUserRegisterEmailConfirmationCommand)
- Aguardo o sistema processar a tarefa de enviar o email de confirmação de registro
