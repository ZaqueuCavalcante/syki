...
{
    [Test]
    public void Should_update_enrollment_period_with_correct_data()
    {
        // Arrange
    ...
    [Test]
    public void Should_not_update_enrollment_period_with_start_equal_to_end()
    {
        // Arrange
        const string id = "2023.1";
        var institutionId = Guid.NewGuid();
    ...
    [Test]
    public void Should_not_update_enrollment_period_with_start_after_end()
    {
        // Arrange
        const string id = "2023.1";
        var institutionId = Guid.NewGuid();
