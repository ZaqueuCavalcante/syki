...
namespace Back.Migrations
{
    ...
    [Migration("20240329225700_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Syki.Back.CreateEvaluationUnits.Evaluation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_evaluations_unit_id");

                    b.ToTable("evaluations", "syki");
                });

            modelBuilder.Entity("Syki.Back.CreateEvaluationUnits.EvaluationUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_evaluation_units");

                    b.HasIndex("TurmaId")
                        .HasDatabaseName("ix_evaluation_units_turma_id");

                    b.ToTable("evaluation_units", "syki");
                });
            ...
            modelBuilder.Entity("Syki.Back.CreateTurma.Turma", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Syki.Back.CreateUser.SykiRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a07563d5-223a-4af7-880b-d65bac1c386e"),
                            ConcurrencyStamp = "f83fb461-f4ba-43d8-b3b0-248624f1a364",
                            Name = "Adm",
                            NormalizedName = "ADM"
                        },
                        new
                        {
                            Id = new Guid("342ec282-ff3d-4ed1-9f9d-7eca2473c1ce"),
                            ConcurrencyStamp = "a9680994-4ca8-4274-b55d-6664b4aa9768",
                            Name = "Academico",
                            NormalizedName = "ACADEMICO"
                        },
                        new
                        {
                            Id = new Guid("7643c6fb-0afa-4d04-bee9-484c4b5a6f6a"),
                            ConcurrencyStamp = "a59859aa-fa8e-4ebc-9ee4-2840f88fe4d5",
                            Name = "Professor",
                            NormalizedName = "PROFESSOR"
                        },
                        new
                        {
                            Id = new Guid("2e12254d-431d-4c18-865b-f792e3e78a1d"),
                            ConcurrencyStamp = "ffebfcb7-c09b-4fad-8593-2bf18de1efb8",
                            Name = "Aluno",
            ...
            modelBuilder.Entity("Syki.Back.CreateEvaluationUnits.Evaluation", b =>
                {
                    b.HasOne("Syki.Back.CreateEvaluationUnits.EvaluationUnit", null)
                        .WithMany("Evaluations")
                        .HasForeignKey("UnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_evaluations_evaluation_unit_evaluation_unit_id");
                });

            modelBuilder.Entity("Syki.Back.CreateEvaluationUnits.EvaluationUnit", b =>
                {
                    b.HasOne("Syki.Back.CreateTurma.Turma", null)
                        .WithMany("Units")
                        .HasForeignKey("TurmaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_evaluation_units_turmas_turma_id");
                });
