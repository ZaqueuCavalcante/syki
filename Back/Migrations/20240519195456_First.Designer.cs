...
namespace Back.Migrations
{
    ...
    [Migration("20240519195456_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Syki.Back.Features.Academic.CreateStudent.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Syki.Back.Features.Academic.CreateTeacher.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Syki.Back.Features.Cross.CreateUser.SykiRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c8e910b9-3f14-4931-9aa9-1085e13fd508"),
                            ConcurrencyStamp = "1e31dedb-ff26-44af-8bf8-cc7373fca0d7",
                            Name = "Adm",
                            NormalizedName = "ADM"
                        },
                        new
                        {
                            Id = new Guid("b3541867-8228-491f-a6d6-c5cd123248bc"),
                            ConcurrencyStamp = "1ac4d76b-8f28-4652-a8b4-f2f828deb042",
                            Name = "Academic",
                            NormalizedName = "ACADEMIC"
                        },
                        new
                        {
                            Id = new Guid("a44a77b1-f7d3-4908-882d-b85118c4e43b"),
                            ConcurrencyStamp = "4d64d2bc-7ffd-44e0-a5d9-584efa18db24",
                            Name = "Teacher",
                            NormalizedName = "TEACHER"
                        },
                        new
                        {
                            Id = new Guid("4ae61238-c56a-4007-a02d-4cb73b882dfe"),
                            ConcurrencyStamp = "d48b98e0-6a11-4ba9-a18c-426a73e5614c",
                            Name = "Student",
            ...
            modelBuilder.Entity("Syki.Back.Features.Academic.CreateClass.Class", b =>
                {
                    ...
                    b.HasOne("Syki.Back.Features.Academic.CreateTeacher.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Syki.Back.Features.Academic.CreateStudent.Student", b =>
                {
                    ...
                    b.HasOne("Syki.Back.Features.Cross.CreateUser.SykiUser", "User")
                        .WithOne()
                        .HasForeignKey("Syki.Back.Features.Academic.CreateStudent.Student", "InstitutionId", "Id")
            ...
            modelBuilder.Entity("Syki.Back.Features.Academic.CreateTeacher.Teacher", b =>
                {
                    ...
                    b.HasOne("Syki.Back.Features.Cross.CreateUser.SykiUser", null)
                        .WithOne()
                        .HasForeignKey("Syki.Back.Features.Academic.CreateTeacher.Teacher", "InstitutionId", "Id")
                        .HasPrincipalKey("Syki.Back.Features.Cross.CreateUser.SykiUser", "InstitutionId", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Syki.Back.Features.Student.CreateStudentEnrollment.ClassStudent", b =>
                {
                    ...
                    b.HasOne("Syki.Back.Features.Academic.CreateStudent.Student", null)
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_classes__students_students_students_temp_id");
                });
