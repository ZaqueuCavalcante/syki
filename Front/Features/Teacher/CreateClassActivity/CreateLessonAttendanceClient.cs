...
{
    public async Task<OneOf<SuccessOut, ErrorOut>> Create(Guid classId, string title, string description, DateTime? dueDate)
    {
        var data = new CreateClassActivityIn { Title = title, Description = description, DueDate = dueDate };
