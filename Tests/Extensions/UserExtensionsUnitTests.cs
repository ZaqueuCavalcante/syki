...
public class UserExtensionsUnitTests
{
    ...
    {
        // Arrange
        var userIdClaim = new Claim(Claims.UserId, Guid.CreateVersion7().ToString());
    ...
    {
        // Arrange
        var institutionIdClaim = new Claim(Claims.InstitutionId, Guid.CreateVersion7().ToString());
